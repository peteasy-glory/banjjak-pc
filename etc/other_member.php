									...
									<div class="set-main-wrap">
										<div class="grid-layout">
											<div class="grid-layout-inner">
												<div class="grid-layout-cell grid-2"><a href="#" class="btn-set-main-menu"><div class="txt">비밀번호 변경</div><div class="icon icon-set-menu-7"></div></a></div>
												...
												<div class="grid-layout-cell grid-2"><a href="#" class="btn-set-main-menu"><div class="txt">탈퇴하기</div><div class="icon icon-set-menu-11"></div></a></div>
											</div>
										</div>
									</div>
								</div>
