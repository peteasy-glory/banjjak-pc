                                    ...
                                    <div class="pay-card-body-inner" id="pay_card_body_inner">
                                        ...
                                        <div class="basic-data-group vmiddle tab-data-group is_approve">
                                            ...
                                            <div class="pay-product-save-btn-wrap sticky-bottom" style="position:sticky; bottom:40px; margin-bottom:50px;">
                                                ...
                                                <button type="button" class="sticky-bottom-inner pay-product-save btn btn-outline-purple btn-middle-size btn-round" id="sticky-bottom" onclick="pay_management_product_change(this,artist_id,session_id)">변경</button>
                                            </div>
    ...
    <div class="layer-pop-parent">
        <div class="layer-pop-children">
            <div class="pop-data alert-pop-data">
                ...
                <button type="button" class="btn-pop-close" style="top:0px; background-size:15px auto;" onclick="pop.close2('reserveCalendarPop2')">닫기</button>            </div>
        </div>
    </div>
</article>
                        ...
                        <div class="allimi-right-wrap">
                            ...
                            <div class="allimi-right-body-history" id="allimi_history">
                                ...
                                <div class="allimi-history-wrap">
                                    ...
                                    <select class="allimi-body-title" style="display:none;" id="allimi_history_select" style="display: none" onchange="allimi_history_change(this);">
                                    </select>
